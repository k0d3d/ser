module.exports = {
  ...
  storage: {
    ...
    S3: {
      key: 'AKIAIGTNT3GD4N2HFFWQ',
      secret: 'kufmcHOLYoZZDNqb94nNqQUXlf7OmX92VA9uAMZi',
      bucket: 'drugstoc-assets',
      storageClass: 'REDUCED_REDUNDANCY',
      secure: false, // (optional) if your BUCKET_NAME contains dot(s), set this to false. Default is `true`
      cdn: 'https://s3-eu-west-1.amazonaws.com/drugstoc-assets/images/uploads' // (optional) if you want to use Amazon cloudfront cdn, enter the cdn url here
    },
